...
--   Date and Time:   05:59 Thursday September 25, 2025
--   Exported By:     730218104019MUHAMMEDMISHAB@GMAIL.COM
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 88859472964735146843
--   Manifest End
--   Version:         24.2.8
...
/
prompt --application/shared_components/plugins/template_component/voice_transcription_and_translation
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(88859472964735146843)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '')
,p_name=>'VOICE_TRANSCRIPTION_AND_TRANSLATION'
...
,p_version_scn=>15655961789969
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(88860969567270853502)
,p_plugin_id=>wwv_flow_imp.id(88859472964735146843)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(88861026430370856648)
,p_plugin_id=>wwv_flow_imp.id(88859472964735146843)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(88862611864940888140)
,p_plugin_id=>wwv_flow_imp.id(88859472964735146843)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(88862643008758889959)
,p_plugin_id=>wwv_flow_imp.id(88859472964735146843)
,p_attribute_scope=>'COMPONENT'
